...
= 0.1.18 =
Documentation only — added an `== Source code ==` section publishing the plugin's GitHub repository and the public source for the vendored web-components bundle, switched `Plugin URI:` to the plugin's repo, and added a top-level GPL-2.0 LICENSE file. No runtime behaviour changes.
